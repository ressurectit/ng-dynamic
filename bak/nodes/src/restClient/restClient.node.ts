...
import {NodeDefinitionGeneric, DynamicOutput, NodeDefinition} from "@anglr/dynamic";
import {DynamicNodeDesignerMetadata, PropertyType, RelationsMetadataGeneric, ɵDynamicRelationsInputMetadata} from "@anglr/dynamic/designer";
