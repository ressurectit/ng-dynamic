 ...
 */
export const GridColumnContentLayoutDesignerTypeLoader: DynamicMetadataLoader<Type<LayoutComponent>> = async () => (await import('./designer/gridColumnContentDesigner.component')).GridColumnContentDesignerComponent;